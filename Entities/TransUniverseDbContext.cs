...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        //=> optionsBuilder.UseSqlServer("Data Source=127.0.0.1,14228;Database=TransUniverseDB;User ID=sa;Password=\"228c@T228\";Trust Server Certificate=True");
        //=> optionsBuilder.UseSqlServer("Data Source=host.docker.internal,14228;Database=TransUniverseDB;User ID=sa;Password=\"228c@T228\";Trust Server Certificate=True");
        => optionsBuilder.UseSqlServer("Data Source=host.docker.internal,22888;Database=TransUniverseDB;User ID=sa;Password=\"228c@T228\";Trust Server Certificate=True");
